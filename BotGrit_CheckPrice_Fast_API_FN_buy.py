...
class OrderManager:
    ...
    def check_price_buy(self,pri,symbol):
        try:
            ...
            price = float(pri)
            status = 3 #| 0 = not Sell 
            orderby = "DATE_SELL desc" #  SYMBOL, PRICE_BUY, PRICE_SELL, STATUS, DATE_BUY, DATE_SELL 
            limit = 1
            # Get data last Buy
            ...
            if order_json != []:
                ...
                if order:
                    ...
                    if status == 1:
                        ...
                        priceActionLast = float(order[0]['price_buy'])
            ...
            for item in OrderSell:
                ...
                if price >= float(item['price_sell']) :
                    ...
                    priceSell = price
                    new_status = 1 
                    qury.update_order_status(item['id'],new_status,priceSell)
